...
public class Constant {
    ...
    public  static  final String CACHE="ljtCache";
    public  static  final String JSON_CACHE="ads_Json";
    public  static  final String JSON_CACHE_TIME_OUT="ads_Json_time_out";
    public  static  final String JSON_CACHE_TIME_NOW="ads_Json_time_now";
